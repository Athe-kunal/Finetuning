...
if __name__ == "__main__":
    ...
    # run_evaluation(model_path="outputs_unsloth/Llama-3.2-3B-Instruct_yaml_xlam/epoch_1", model_name=LLAMA_3_2_3B_INSTRUCT, json_or_yaml="yaml", dataset_name="xlam")
    # run this below
    # run_evaluation(model_path="outputs_unsloth/Llama-3.2-3B-Instruct_yaml_xlam/epoch_2", model_name=LLAMA_3_2_3B_INSTRUCT, json_or_yaml="yaml", dataset_name="xlam")
    # run_evaluation(model_path="outputs_unsloth/Llama-3.2-3B-Instruct_yaml_xlam/epoch_3", model_name=LLAMA_3_2_3B_INSTRUCT, json_or_yaml="yaml", dataset_name="xlam")
    ...
    run_evaluation(model_path="outputs_unsloth/llama-3-8b-Instruct_yaml_bfcl/epoch_1", model_name=LLAMA_3_1_8B_INSTRUCT, json_or_yaml="yaml", dataset_name="bfcl",val_batch_size=32)
    # run_evaluation(model_path="outputs_unsloth/llama-3-8b-Instruct_yaml_bfcl/epoch_2", model_name=LLAMA_3_1_8B_INSTRUCT, json_or_yaml="yaml", dataset_name="bfcl",val_batch_size=32)
    # run_evaluation(model_path="outputs_unsloth/llama-3-8b-Instruct_yaml_bfcl/epoch_3", model_name=LLAMA_3_1_8B_INSTRUCT, json_or_yaml="yaml", dataset_name="bfcl",val_batch_size=32)
    ...
    # run_evaluation(model_path="outputs_unsloth/llama-3-8b-Instruct_yaml_xlam/epoch_3", model_name=LLAMA_3_1_8B_INSTRUCT, json_or_yaml="yaml", dataset_name="xlam",val_batch_size=32)
